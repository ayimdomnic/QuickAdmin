...
use Ayim\Quickadmin\Widget\Breadcrumbs;
use Ayim\Quickadmin\Widget\Link;
use Ayim\Quickadmin\Widget\Menu\Item;
use Ayim\Quickadmin\Widget\Menu\Menu;
...
abstract class QuickadminController extends BaseController
{
    ...
    public static function menuCrud($title, $icon = '', $extra_items = [], $indicator = null)
    {
        ...
        if (method_exists('\\'.get_called_class(), 'create')) {
